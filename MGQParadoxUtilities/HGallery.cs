...
/*
public class HSceneItems
{
    private readonly List<HSceneItem> entries = new List<HSceneItem>();
    public List<HSceneItem> Entries 
    { 
        get { return entries; } 
    }
}

public class HSceneItem
{
    public string Name { get; set; }
    public HSceneCondition Condition { get; set; }
    public List<HSceneCGItem> CG {  get; set; }
...
public class HSceneCGItem
{
    public HSceneGGRegist RegisteredPictures { get; set; }
    public HSceneGGDrawOrder DrawOrder { get; set; }
    public HSceneCondition Condition { get; set; }
    public HSceneGGBackground Background { get; set; }
}

public class HSceneGGRegist
{
    public List<KeyValuePair<string, string>> Pictures { get; set; }
}

public class HSceneGGDrawOrder
{
    public List<List<int>> DrawOrder { get; set; }
}
